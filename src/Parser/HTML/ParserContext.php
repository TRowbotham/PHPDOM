...
final class ParserContext
{
     ...
     */
    public int $encodingConfidence;

    /**
     * The last form element that was opened and has not yet been closed.
     */
    public ?HTMLFormElement $formElementPointer;

    /**
     * The parsed head element.
     */
    public ?HTMLHeadElement $headElementPointer;

    public CodePointStream $input;
     ...
     */
    public OpenElementStack $openElements;

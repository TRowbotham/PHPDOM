...
/**
 * @see https://github.com/web-platform-tests/wpt/blob/master/dom/traversal/TreeWalker-traversal-reject.html
 */
class TreeWalkerTraversalRejectTest extends TestCase
{
    ...
    public function testFirstChild(): void
    {
        ...
        $this->assertNode(['type' => Element::class, 'id' => 'B2'], $walker->firstChild());
    }

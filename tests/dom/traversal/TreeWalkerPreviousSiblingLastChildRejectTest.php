...
/**
 * @see https://github.com/web-platform-tests/wpt/blob/master/dom/traversal/TreeWalker-previousSiblingLastChildSkip.html
 */
class TreeWalkerPreviousSiblingLastChildRejectTest extends TestCase
{
    ...
    public function testThatPreviousNodeProperlyRespectsTheFilter(): void
    {
        ...
        $this->assertNode(['type' => Element::class, 'id' => 'C2'], $walker->nextNode());
        $this->assertNode(['type' => Element::class, 'id' => 'C2'], $walker->currentNode);
        $this->assertNode(['type' => Element::class, 'id' => 'D1'], $walker->nextNode());
        $this->assertNode(['type' => Element::class, 'id' => 'D1'], $walker->currentNode);
        $this->assertNode(['type' => Element::class, 'id' => 'D2'], $walker->nextNode());
        $this->assertNode(['type' => Element::class, 'id' => 'D2'], $walker->currentNode);
        $this->assertNode(['type' => Element::class, 'id' => 'B2'], $walker->nextNode());
        $this->assertNode(['type' => Element::class, 'id' => 'B2'], $walker->currentNode);
        $this->assertNode(['type' => Element::class, 'id' => 'C2'], $walker->previousSibling());
        $this->assertNode(['type' => Element::class, 'id' => 'C2'], $walker->currentNode);
    }

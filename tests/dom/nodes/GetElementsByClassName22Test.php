...
/**
 * @see https://github.com/web-platform-tests/wpt/blob/master/dom/nodes/getElementsByClassName-22.htm
 */
class GetElementsByClassName22Test extends NodeTestCase
{
    use WindowTrait;
    ...
    {
        return 'getElementsByClassName-22.html';
    }
}

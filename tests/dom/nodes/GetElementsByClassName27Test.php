...
/**
 * @see https://github.com/web-platform-tests/wpt/blob/master/dom/nodes/getElementsByClassName-27.htm
 */
class GetElementsByClassName27Test extends NodeTestCase
{
    use WindowTrait;
    ...
    {
        return 'getElementsByClassName-27.html';
    }
}

...
/**
 * @see https://github.com/web-platform-tests/wpt/blob/master/html/semantics/document-metadata/the-base-element/base_href_empty.html
 */
class Base_href_emptyTest extends TestCase
{
    use WindowTrait;

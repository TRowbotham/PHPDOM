...
/**
 * @see https://github.com/web-platform-tests/wpt/blob/master/html/syntax/parsing/Element.getElementsByTagName-foreign-02.html
 */
class Element_getElementsByTagName_foreign_02Test extends TestCase
{
    use WindowTrait;
    ...
    {
        return 'Element.getElementsByTagName-foreign-02.html';
    }

...
/**
 * @see https://github.com/web-platform-tests/wpt/blob/master/html/syntax/parsing/template/additions-to-the-in-body-insertion-mode/generating-of-implied-end-tags.html
 */
class Generating_of_implied_end_tagsTest extends TestCase
{
    ...
    {
        $doc = FakeIframe::load(self::RESOURCES_DIR . DS . 'template-contents-table-no-end-tag.html')->contentDocument;
    ...
    {
        $doc = FakeIframe::load(self::RESOURCES_DIR . DS . 'template-contents-div-no-end-tag.html')->contentDocument;
